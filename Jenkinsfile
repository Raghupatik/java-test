 ...
 main
        ...
        stage('Push') {
            steps {
                ...
                sh "aws s3 cp target/sample-1.0.3.jar s3://ang-ui"
            }
        }
            ...
            parallel {
                ...
                stage('Deploy to Dev') {
                    steps {
                        ...
                        sh "aws lambda update-function-code --function-name $function_name --region us-east-1 --s3-bucket ang-ui --s3-key sample-1.0.3.jar"
                    }
                }
